...
Test-Gate ($controller.Contains("RunEditorStormWaterOwnershipProbe")) "storm drinking water keeps a single physical owner"
...
Test-Gate ($visualProbe.Contains("RunEditorStormWaterOwnershipProbe")) "visual gate covers storm water conservation"
